...
export default function Home() {
  return (
    <main className="bg-paper text-ink">
        ...
        <FadeUp>
          ...
          <div className="prose-cream">
            ...
            <p>
              ...
              profiles across six countries to reconstruct online signup patterns. Four questions, one
              dataset, several weekends of matcha.
            </p>
          </div>
        </FadeUp>
      </section>
      ...
      <footer className="max-w-2xl mx-auto px-6 py-12 text-center text-xs text-sage-600 tracking-wider">
